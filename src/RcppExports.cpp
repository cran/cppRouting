...
RcppExport SEXP _cppRouting_Detour(SEXP depSEXP, SEXP arrSEXP, SEXP gfromSEXP, SEXP gtoSEXP, SEXP gwSEXP, SEXP NbNodesSEXP, SEXP tSEXP, SEXP dictSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::vector<int> >::type dep(depSEXP);
    ...
    Rcpp::traits::input_parameter< std::vector<std::string> >::type dict(dictSEXP);
    rcpp_result_gen = Rcpp::wrap(Detour(dep, arr, gfrom, gto, gw, NbNodes, t, dict));
    return rcpp_result_gen;
END_RCPP
}
// Dijkstra_early_stop
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_cppRouting_Detour", (DL_FUNC) &_cppRouting_Detour, 8},
